	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.antMatchers("/job/recruiters/cloneJob/{jobId}/{jobRecruiterId}", "/viewjob/recruiter/viewjob/{jobId}",
						...
						"/team/{teamMemberId}/reset-password", "/job/recruiterscountjobs/{recruiterId}","/videos/updateThumbnail/{videoId}","/videos/uploadVideo",
						"/team/{teamMemberId}/reset-password", "/job/recruiterscountjobs/{recruiterId}",
				        "/blogs/inactive","/blogs/all","/blogs/updateOrDelete","/blogs/getBlogById/{id}",
				...
				.antMatchers("/jobVisit/applicant/track-visit","/skill-badges/{id}/skill-badges","/skill-badges/save","/savedjob/applicants/deletejob/{applicantId}/{jobId}", "/applicant/{id}/profilestatus",
						...
						"/api/mentor-connect/getAllMeetings","/api/mentor-connect/getMeetingById/{id}",
						...
						"/api/hackathons/recommended/{applicantId}", "/api/hackathons/getApplicantRegisteredHackathons/{applicantId}",
						"/hackathons/{hackathonId}/getRegistrationStatus/{applicantId}", "/api/hackathons/{hackathonId}/submit", 
						"/applicant-image/hackathon/winners", "/hackathons/{applicantId}/getAllRegistrationStatus",
						"/hackathons/{hackathonId}/registerForHackathon/{applicantId}")
